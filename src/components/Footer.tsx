...
const Footer = () => {
    return (
        <footer className='flex items-center gap-3 md:gap-20 justify-center  bottom-0 left-0 w-full bg-gradient-to-t from-mainPurple to-mainPurple/5  backdrop-blur-sm px-20 py-5 '>
